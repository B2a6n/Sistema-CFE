...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 07, 2025 at 07:32 PM
...
(1, 'Arroyo', '9212075738', 'La Cima', '91637', 'Xalapa', 'Veracruz'),
(2, 'Arroyo', '4B', 'La Cima', '91637', 'Xalapa', 'Veracruz'),
(3, 'Arroyo', '4', 'La Cima', '91637', 'Xalapa', 'Veracruz'),
(4, 'Arroyo', '4B', 'La Cima', '91637', 'Xalapa', 'Veracruz'),
(5, 'Arroyo', '4B', 'La Cima', '91637', 'Xalapa', 'Veracruz'),
(6, 'Arroyo', '4B', 'La Cima', '91637', 'Xalapa', 'Veracruz'),
(7, 'Arroyo', '4B', 'La Cima', '91637', 'Xalapa', 'Veracruz');
...
INSERT INTO `servicios` (`id_servicio`, `numero_servicio`, `id_usuario`, `id_direccion`, `tipo_servicio`, `estatus`) VALUES
(7, 'CFE-2025-4858', 10, 7, 'Residencial', 'Activo');
...
(10, 'Jaciel', 'Martinez Benitez', 'MABJ041117HVZRNCA1', '9212075738', 'martinezbenitezjaciel@gmail.com', '123', '2004-11-17');
...
ALTER TABLE `servicios`
  ...
  ADD UNIQUE KEY `numero_servicio` (`numero_servicio`),
...
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`id_servicio`) REFERENCES `servicios` (`id_servicio`);
